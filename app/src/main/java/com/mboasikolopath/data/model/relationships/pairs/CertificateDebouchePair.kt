...
@DatabaseView(
    """
    SELECT Certificate.CertificateID as Certificate_CertificateID, Certificate.Name as Certificate_Name, Certificate.SeriesID as Certificate_SeriesID, Debouche.* 
    FROM Certificate 
